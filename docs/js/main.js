...
function updateLinks() {
  links.forEach((link) => {
    link.addEventListener("mouseenter", updateSelection2);
    link.addEventListener("mouseleave", updateSelection2);
    if (link.origin != origin || link.hasAttribute("data-force-reload")) {
      return;
    }
